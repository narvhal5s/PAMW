...
let UniqueUserNameValidator = class UniqueUserNameValidator {
    ...
    validate(ctrl) {
        return this.LoginService.isNameTaken(ctrl.value).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["map"])(isTaken => (isTaken ? { uniqueUserName: true } : null)), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(() => null));
    }
};
UniqueUserNameValidator.ctorParameters = () => [
...
let UniqueUsernameValidatorDirective = class UniqueUsernameValidatorDirective {
...
UniqueUsernameValidatorDirective.ctorParameters = () => [
        ...
        providers: [
            {
                ...
                useExisting: Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["forwardRef"])(() => UniqueUserNameValidator),
                multi: true
            }
        ]
    })
...
let PdfService = class PdfService {
    ...
    check() {
        this.http.get(this.url + "/check", this.httpOptions).subscribe(data => { console.log(data.username); }, error => { console.log(error); });
    }
    uploadFile(file) {
        this.http.post(this.url + "/uploadFile", file, this.httpOptions).subscribe(data => console.log(data), error => console.log(error));
    }
    getFilesLinks() {
...
let SignupFormComponent = class SignupFormComponent {
    constructor(loginService, userNameValidator) {
        this.loginService = loginService;
